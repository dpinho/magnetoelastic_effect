...
\end{equation*}
e desse jeito podemos perceber que o fator $(1+\epsilon_{11})$ \'e uma mudan\c{c}a relativa no comprimento ao longo do eixo $x_1$ devido a deforma\c{c}\~ao.
