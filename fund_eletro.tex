...
Agora vamos utilizar um circuito Stokesiano para determinar as componentes tangenciais \`a superf\'icie dos campos el\'etrico e magn\'etico auxiliar. Considerando desprez\'ivel a altura da superf\'icie formada pelo circuito retangular, e que seus outros dois lados s\~ao paralelos e t\^em comprimento $\Delta l$, ent\~ao o lado esquerdo da equa\c{c}\~ao \ref{eq.max_meio_3} \'e calculado como
